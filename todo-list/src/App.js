...
// filter out task to be deleted
    ...
    // if task list is empty, set noTasks to true
    ...
    return (
        ...
        <div id='all-lists-container'>
            ...
            {/* no task placeholders */}
            {/* if title is empty - acting as placeholder in grid for no tasks display */}
            {!showForm && noTasks && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='' tasks={zeroTasks} toggleForm={toggleForm} handleEdit={handleEdit} />}
            {!showForm && noTasks && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='NO TASKS' tasks={zeroTasks} toggleForm={toggleForm} handleEdit={handleEdit} />}
            {!showForm && noTasks && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='' tasks={zeroTasks} toggleForm={toggleForm} handleEdit={handleEdit} />}
            {!showForm && noTasks && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='' tasks={zeroTasks} toggleForm={toggleForm} handleEdit={handleEdit} />}
            {!showForm && noTasks && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='' tasks={zeroTasks} toggleForm={toggleForm} handleEdit={handleEdit} />}
            {!showForm && noTasks && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='' tasks={zeroTasks} toggleForm={toggleForm} handleEdit={handleEdit} />}
            ...
            {!showForm && !noTasks && (overdueTasks.length !== 0 && overdueTasks !== null) && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='OVERDUE' tasks={overdueTasks} toggleForm={toggleForm} handleEdit={handleEdit} />}
            {!showForm && !noTasks && (todayTasks.length !== 0 && todayTasks !== null) && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='TODAY' tasks={todayTasks} toggleForm={toggleForm} handleEdit={handleEdit}/>}
            {!showForm && !noTasks && (tomorrowTasks.length !== 0 && tomorrowTasks !== null) && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='TOMORROW' tasks={tomorrowTasks} toggleForm={toggleForm} handleEdit={handleEdit}/>}
            {!showForm && !noTasks && (nextWeekTasks.length !== 0 && nextWeekTasks !== null) && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='THIS WEEK' tasks={nextWeekTasks} toggleForm={toggleForm} handleEdit={handleEdit}/>}
            {!showForm && !noTasks && (futureTasks.length !== 0 && futureTasks !== null) && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='FUTURE' tasks={futureTasks} toggleForm={toggleForm} handleEdit={handleEdit}/>}
            {!showForm && !noTasks && (completedTasks.length !== 0 && completedTasks !== null) && <TodoList completeTask={completeTask} deleteTask={deleteTask} title='COMPLETED' tasks={completedTasks} toggleForm={toggleForm} handleEdit={handleEdit}/>}
